...
const insertCadet = (cadet) => {
    return new Promise((resolve, reject) => {
        const sql = `INSERT INTO cadets (
            ...
            cadet_course, semester, gender, status, is_profile_completed
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`;
        ...
        const params = [
            ...
            cadet.cadet_course || '', cadet.semester || '', cadet.gender || '', 'Ongoing', false
        ];
...
const updateCadet = (id, cadet) => {
    return new Promise((resolve, reject) => {
        ...
        const params = [
            ...
            cadet.course || '', cadet.year_level || '', cadet.school_year || '',
            cadet.battalion || '', cadet.company || '', cadet.platoon || '',
            cadet.cadet_course || '', cadet.semester || '', cadet.gender || '',
            id
        ];

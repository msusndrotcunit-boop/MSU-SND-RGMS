...
router.post('/broadcast-onboarding', authenticateToken, isAdmin, (req, res) => {
    ...
    db.all(sql, [], async (err, rows) => {
        ...
        const subject = 'MSU-SND ROTC Grading System - Your Login Credentials';

        const tasks = rows.map((u) => {
            if (u.role === 'training_staff') {
                const namePartsStaff = [];
                if (u.staff_rank) namePartsStaff.push(u.staff_rank);
                if (u.staff_first_name) namePartsStaff.push(u.staff_first_name);
                if (u.staff_middle_name) namePartsStaff.push(u.staff_middle_name);
                if (u.staff_last_name) namePartsStaff.push(u.staff_last_name);
                const staffName = namePartsStaff.join(' ').trim() || u.username || 'Training Staff';
                const staffRole = u.staff_role || 'Training Staff';
                const tempPasswordLabel = 'Your existing ROTC system password (not sent via email)';

                const textLinesStaff = [
                    `Subject: MSU-SND ROTC Grading System - Your Staff Account Credentials`,
                    '',
                    `Dear ${staffName},`,
                    '',
                    'Welcome to the MSU-SND ROTC Grading Management System as a member of the training staff.',
                    'Your staff account has been successfully created.',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'YOUR LOGIN CREDENTIALS',
                    `Role/Position: ${staffRole}`,
                    `Username: ${u.username}`,
                    `Email: ${u.email}`,
                    `Temporary Password: ${tempPasswordLabel}`,
                    'IMPORTANT: Please change your password after your first login for security purposes.',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ACCESS THE SYSTEM',
                    `Click here to access: ${appUrl}`,
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ABOUT THE MSU-SND ROTC GRADING MANAGEMENT SYSTEM',
                    'The MSU-SND ROTC Grading Management System is a comprehensive digital platform used to manage cadet grades, attendance, performance, and communications at Mindanao State University – Sultan Naga Dimaporo ROTC Unit.',
                    '',
                    'AS TRAINING STAFF, YOU CAN USE THIS SYSTEM TO:',
                    '• Encode and review cadet grades and performance',
                    '• Monitor attendance and training participation',
                    '• Track merit and demerit records',
                    '• Publish and view official announcements and activities',
                    '• Coordinate with other staff members and administrators',
                    '',
                    'PURPOSE:',
                    'This system supports efficient and transparent management of ROTC academic and training records. It reduces manual paperwork, improves data accuracy, and provides a clear overview of cadet performance to assist in decision-making and evaluation.',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'IMPORTANT REMINDERS:',
                    '• Keep your login credentials secure and confidential',
                    '• Do not share your password with anyone, including cadets',
                    '• Change your password immediately after your first login',
                    '• Log out when using shared or public computers',
                    '• Use the system responsibly in accordance with ROTC policies',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'NEED HELP?',
                    'If you have any questions or need assistance, please contact the ROTC administrator or system administrator.',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'Best regards,',
                    'MSU-SND ROTC Administration',
                    "Mindanao State University - Sulu Northern District Reserve Officers' Training Corps",
                    `System Link: ${appUrl}`
                ];
                const textStaff = textLinesStaff.join('\n');

                const htmlStaff = `
                    <p>Dear ${staffName},</p>
                    <p>Welcome to the <strong>MSU-SND ROTC Grading Management System</strong> as a member of the training staff. Your staff account has been successfully created.</p>
                    <hr/>
                    <h3>YOUR LOGIN CREDENTIALS</h3>
                    <p>
                        Role/Position: <strong>${staffRole}</strong><br/>
                        Username: <strong>${u.username}</strong><br/>
                        Email: <strong>${u.email}</strong><br/>
                        Temporary Password: <strong>${tempPasswordLabel}</strong><br/>
                        <em>For security reasons, your actual password is not sent via email.</em>
                    </p>
                    <p><strong>IMPORTANT:</strong> Please change your password after your first login for security purposes.</p>
                    <hr/>
                    <h3>ACCESS THE SYSTEM</h3>
                    <p>Click here to access: <a href="${appUrl}">${appUrl}</a></p>
                    <hr/>
                    <h3>ABOUT THE MSU-SND ROTC GRADING MANAGEMENT SYSTEM</h3>
                    <p>
                        The MSU-SND ROTC Grading Management System is a comprehensive digital platform used to manage cadet grades, attendance,
                        performance, and communications at Mindanao State University – Sultan Naga Dimaporo ROTC Unit.
                    </p>
                    <h4>AS TRAINING STAFF, YOU CAN USE THIS SYSTEM TO:</h4>
                    <ul>
                        <li>Encode and review cadet grades and performance</li>
                        <li>Monitor attendance and training participation</li>
                        <li>Track merit and demerit records</li>
                        <li>Publish and view official announcements and activities</li>
                        <li>Coordinate with other staff members and administrators</li>
                    </ul>
                    <h4>PURPOSE:</h4>
                    <p>
                        This system supports efficient and transparent management of ROTC academic and training records. It reduces manual paperwork,
                        improves data accuracy, and provides a clear overview of cadet performance to assist in decision-making and evaluation.
                    </p>
                    <hr/>
                    <h3>IMPORTANT REMINDERS:</h3>
                    <ul>
                        <li>Keep your login credentials secure and confidential</li>
                        <li>Do not share your password with anyone, including cadets</li>
                        <li>Change your password immediately after your first login</li>
                        <li>Log out when using shared or public computers</li>
                        <li>Use the system responsibly in accordance with ROTC policies</li>
                    </ul>
                    <hr/>
                    <h3>NEED HELP?</h3>
                    <p>If you have any questions or need assistance, please contact the ROTC administrator or system administrator.</p>
                    <hr/>
                    <p>
                        Best regards,<br/>
                        <strong>MSU-SND ROTC Administration</strong><br/>
                        Mindanao State University - Sulu Northern District Reserve Officers' Training Corps
                    </p>
                    <p><strong>System Link:</strong> <a href="${appUrl}">${appUrl}</a></p>
                `;

                return sendEmail(u.email, subject, textStaff, htmlStaff);
            }

            const nameParts = [];
            if (u.first_name) nameParts.push(u.first_name);
            if (u.middle_name) nameParts.push(u.middle_name);
            if (u.last_name) nameParts.push(u.last_name);
            const studentName = nameParts.join(' ') || u.username || 'Cadet';
            const studentId = u.student_id || 'N/A';
            const tempPasswordLabel = 'Your existing ROTC system password (not sent via email)';

            const textLines = [
                `Subject: MSU-SND ROTC Grading System - Your Login Credentials`,
                '',
                `Dear ${studentName},`,
                '',
                'Welcome to the MSU-SND ROTC Grading Management System!',
                ...
                '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                'ABOUT THE MSU-SND ROTC GRADING MANAGEMENT SYSTEM',
                'The MSU-SND ROTC Grading Management System is a comprehensive digital platform designed to streamline and modernize the grading and academic management process for ROTC students at Mindanao State University – Sultan Naga Dimaporo ROTC Unit.',
                '',
                'SYSTEM CAPABILITIES:',
                '• Grade Management – View your academic performance, grades, and assessments in real-time',
                '• Performance Tracking – Monitor your progress throughout the semester with detailed analytics',
                '• Secure Access – Protected login system ensuring your academic data remains confidential',
                '• Digital Records – Access your academic records anytime, anywhere with internet connectivity',
                '• Transparent Evaluation – Clear visibility into grading criteria and assessment results',
                '• Communication Hub – Stay updated with announcements and important notifications from instructors',
                '',
                'PURPOSE:',
                'This system aims to enhance the educational experience by providing a centralized, efficient, and transparent platform for managing ROTC academic records. It eliminates manual processes, reduces administrative burden, and empowers students with instant access to their academic standing, fostering accountability and academic excellence within the MSU-SND ROTC program.',
                '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                'IMPORTANT REMINDERS:',
                '• Keep your login credentials secure and confidential',
                '• Do not share your password with anyone',
                '• Change your password immediately after your first login',
                '• If you encounter any issues accessing the system, please contact your ROTC administrator',
                '• Regularly check the system for updates on your grades and announcements',
                '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                'NEED HELP?',
                'If you have any questions or need assistance, please contact the ROTC office or your system administrator.',
                '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                'Best regards,',
                'MSU-SND ROTC Administration',
                "Mindanao State University - Sulu Northern District Reserve Officers' Training Corps",
            ...
            const html = `
                ...
                <p>Welcome to the <strong>MSU-SND ROTC Grading Management System</strong>! Your account has been successfully created.</p>
                <hr/>
                <h3>YOUR LOGIN CREDENTIALS</h3>
                <p>
                ...
                <h3>ABOUT THE MSU-SND ROTC GRADING MANAGEMENT SYSTEM</h3>
                <p>
                    The MSU-SND ROTC Grading Management System is a comprehensive digital platform designed to streamline and modernize
                    the grading and academic management process for ROTC students at Mindanao State University – Sultan Naga Dimaporo ROTC Unit.
                </p>
                <h4>SYSTEM CAPABILITIES:</h4>
                <ul>
                    <li>Grade Management – View your academic performance, grades, and assessments in real-time</li>
                    <li>Performance Tracking – Monitor your progress throughout the semester with detailed analytics</li>
                    <li>Secure Access – Protected login system ensuring your academic data remains confidential</li>
                    <li>Digital Records – Access your academic records anytime, anywhere with internet connectivity</li>
                    <li>Transparent Evaluation – Clear visibility into grading criteria and assessment results</li>
                    <li>Communication Hub – Stay updated with announcements and important notifications from instructors</li>
                </ul>
                <h4>PURPOSE:</h4>
                <p>
                    This system aims to enhance the educational experience by providing a centralized, efficient, and transparent platform
                    for managing ROTC academic records. It eliminates manual processes, reduces administrative burden, and empowers students
                    with instant access to their academic standing, fostering accountability and academic excellence within the MSU-SND ROTC program.
                </p>
                <hr/>
                <h3>IMPORTANT REMINDERS:</h3>
                <ul>
                    ...
                    <li>Change your password immediately after your first login</li>
                    <li>If you encounter any issues accessing the system, please contact your ROTC administrator</li>
                    <li>Regularly check the system for updates on your grades and announcements</li>
                </ul>
                <hr/>
                <h3>NEED HELP?</h3>
                <p>If you have any questions or need assistance, please contact the ROTC office or your system administrator.</p>
                <hr/>
                <p>
                    Best regards,<br/>
                    <strong>MSU-SND ROTC Administration</strong><br/>
...
router.post('/broadcast-onboarding-staff', authenticateToken, isAdmin, (req, res) => {
    const emailUser = process.env.EMAIL_USER;
    const emailPass = process.env.EMAIL_PASS;
    ...
    db.all(sql, [], async (err, rows) => {
        if (err) return res.status(500).json({ message: err.message });
        if (!rows || rows.length === 0) {
            return res.status(400).json({ message: 'No training staff users with email found.' });
        }

        const baseUrl = `${req.protocol}://${req.get('host')}`;
        const appUrl = `${baseUrl}/login`;

        const subject = 'MSU-SND ROTC Grading System - Your Staff Account Credentials';
        ...
        try {
            ...
            if (successCount === 0) {
                return res.status(500).json({
                    message: 'Failed to send staff onboarding emails. Please check email configuration (EMAIL_USER/EMAIL_PASS) and server logs.'
                });
            }

            res.json({ message: `Staff onboarding email sent to ${successCount} users. Failed: ${failCount}.` });
        } catch (e) {
            console.error('Broadcast staff onboarding email error:', e);
            res.status(500).json({ message: 'Failed to send staff onboarding emails due to an unexpected server error.' });
        }
    });
});

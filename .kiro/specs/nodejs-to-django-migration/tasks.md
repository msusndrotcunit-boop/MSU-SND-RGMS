...
- [x] 1. Django project setup and configuration
  - [x] 1.1 Create Django project structure with config/ and apps/ directories
  ...
  - [x] 1.3 Configure CORS and static files
  ...
  - [x] 1.4 Configure environment variables and secrets
...
- [x] 2. Database models for all 19 tables
  - [x] 2.1 Create authentication app with User and UserSettings models
  ...
  - [x] 2.3 Create cadets app with Cadet and Grades models
  ...
  - [x] 2.5 Create grading app with MeritDemeritLog model
  ...
  - [x] 2.7 Create attendance app with TrainingDay, AttendanceRecord, StaffAttendanceRecord, ExcuseLetter models
  ...
  - [x] 2.9 Create activities app with Activity and ActivityImage models
  ...
  - [x] 2.10 Create staff app with TrainingStaff model
  ...
  - [x] 2.11 Create messaging app with AdminMessage, StaffMessage, Notification, PushSubscription models
  ...
  - [x] 2.12 Create system app with SystemSettings, AuditLog, SyncEvent models
  ...
  - [x] 2.14 Run database migrations and verify schema
...
- [x] 4. Authentication system with bcrypt compatibility
  - [x] 4.1 Implement bcrypt password hashing backend
  ...
  - [x] 4.3 Implement JWT token authentication
  ...
  - [x] 4.5 Implement role-based permission classes
  ...
  - [x] 4.7 Create authentication API endpoints
...
- [x] 5. Cadet management API endpoints
  - [x] 5.1 Create cadet serializers with nested grades
  ...
  - [x] 5.2 Implement cadet list and detail endpoints
  ...
  - [x] 5.4 Implement cadet create, update, delete endpoints
  ...
  - [x] 5.6 Implement profile picture upload for cadets
...
- [x] 6. Grading system API endpoints
  - [x] 6.1 Create grades and merit/demerit serializers
  ...
  - [x] 6.2 Implement grades list and detail endpoints
  ...
  - [x] 6.3 Implement grades update endpoint
  ...
  - [x] 6.4 Implement merit/demerit log endpoints
  ...
  - [x] 6.5 Implement automatic grade updates via Django signals
  ...
  - [x] 6.7 Implement audit logging for grade changes
  ...
  - [x] 6.8 Implement sync events for real-time updates
...
- [x] 7. Checkpoint - Verify core API functionality
...
- [x] 8. Attendance tracking API endpoints
  - [x] 8.1 Create attendance serializers
  ...
  - [x] 8.2 Implement training day endpoints
  ...
  - [x] 8.3 Implement cadet attendance endpoints
  ...
  - [x] 8.4 Implement attendance grade update via signals
  ...
  - [x] 8.5 Implement staff attendance endpoints
  ...
  - [x] 8.6 Implement QR code attendance check-in
...
- [x] 9. Excuse letter management API endpoints
  - [x] 9.1 Implement excuse letter endpoints
  ...
  - [x] 9.2 Implement excuse letter approval logic
...
- [x] 10. Activities and achievements API endpoints
  ...
  - [x] 10.3 Implement multiple image upload for activities
...
- [x] 12. Messaging system API endpoints
  ...
  - [x] 12.3 Implement staff message endpoints
  ...
  - [x] 12.4 Implement notification creation on new messages
...
- [x] 13. Notification system API endpoints
  - [x] 13.1 Create notification serializers
    - Create NotificationSerializer
    - Create PushSubscriptionSerializer
    - _Requirements: 12.5, 12.14_

  - [x] 13.2 Implement notification endpoints
  ...
  - [x] 13.3 Implement push notification subscription endpoints
...
- [x] 15. File upload and Cloudinary integration
  - [x] 15.1 Configure Cloudinary with django-storages
  ...
  - [x] 15.2 Create file upload service
  ...
  - [x] 15.3 Implement file upload endpoint
  ...
  - [x] 15.5 Implement file deletion endpoint
    - Implement DELETE /api/upload/:public_id
    - Delete file from Cloudinary
    - Return success/failure status
    - _Requirements: 7.11_

  - [x] 15.6 Implement activity image upload handling
  ...
  - [x] 15.8 Preserve existing Cloudinary URLs during migration
    - Ensure migration script preserves all URL fields
    - Validate URLs are accessible after migration
    - _Requirements: 7.12_

- [x] 16. Redis caching implementation
  - [x] 16.1 Configure Redis cache backend
  ...
  - [x] 16.4 Add caching to grades endpoints
  ...
  - [x] 16.9 Implement cache statistics endpoint
    - Implement GET /api/cache/stats
    - Return cache hit/miss ratios
    - Restrict to admin role
    - _Requirements: 15.7, 20.4_

  - [x] 16.10 Implement cache clear endpoint
    - Implement POST /api/cache/clear
    - Clear all cache entries
    - Restrict to admin role
    - _Requirements: 15.14_

- [x] 17. Django Channels for real-time updates
  - [x] 17.1 Configure Django Channels and Redis channel layer
  ...
  - [x] 17.2 Create WebSocket consumer for updates
  ...
  - [x] 17.3 Implement WebSocket broadcasting for grade updates
  ...
  - [x] 17.9 Implement WebSocket error handling
    - Handle connection errors gracefully
    - Implement reconnection logic
    - Support message replay for disconnected clients
    - _Requirements: 13.14, 13.15_

- [x] 18. Celery for background task processing
  - [x] 18.1 Configure Celery with Redis broker
  ...
  - [x] 18.2 Create image compression background task
  ...
  - [x] 18.3 Create PDF generation background task
  ...
  - [x] 18.4 Create OCR processing background task
  ...
  - [x] 18.5 Create bulk import background task
  ...
  - [x] 18.12 Implement Celery worker health check endpoint
    - Implement GET /api/celery/health
    - Check worker status and queue length
    - Restrict to admin role
    - _Requirements: 14.15_

  - [x]* 18.13 Write integration tests for Celery tasks
    - Test task execution and results
    - Test retry logic
    - Test task status tracking

- [x] 19. Checkpoint - Verify advanced features
...
- [x] 20. System settings and user preferences API
  - [x] 20.1 Create system settings serializers
    - Create SystemSettingsSerializer
    - Create UserSettingsSerializer
    - _Requirements: 17.13, 18.10_

  - [x] 20.2 Implement system settings endpoints
  ...
  - [x] 20.3 Implement default system settings
...
- [x] 22. PDF generation and reporting
  ...
  - [x] 22.4 Implement attendance report PDF endpoint
...
- [x] 24. Data import/export and ROTCMIS integration
  ...
  - [x] 24.2 Implement ROTCMIS import endpoint
  ...
  - [x] 24.3 Implement import status and error reporting
  ...
  - [x] 24.4 Implement Excel export endpoint
...
- [x] 25. Performance monitoring and metrics
  ...
  - [x] 25.2 Implement metrics endpoint
  ...
  - [x] 25.3 Implement database metrics endpoint
...
- [x] 27. Security hardening and error handling
  - [x] 27.1 Configure Django security settings
  ...
  - [x] 27.2 Implement rate limiting
  ...
  - [x] 27.3 Implement input validation and sanitization
...
- [x] 29. API compatibility and response formatting
  ...
  - [x] 29.9 Implement CORS header consistency
...
- [x] 31. Checkpoint - Verify security and performance
...
- [x] 32. Data migration scripts and validation
  - [x] 32.1 Create data export script for Node.js database
  ...
  - [x] 32.2 Implement data validation before migration
  ...
  - [x] 32.3 Create data import script for Django database
  ...
  - [x] 32.4 Preserve timestamps and special fields
  ...
  - [x]* 32.5 Write property tests for data migration
    - **Property 34: Data Migration Preservation**
    - **Validates: Requirements 23.3, 23.6, 23.7, 23.8**

  - [x] 32.6 Implement migration verification script
  ...
  - [x] 32.7 Implement rollback capability
...
- [ ] 34. Render.com deployment configuration
  - [x] 34.1 Create render.yaml configuration file
  ...
  - [x] 34.9 Test deployment to Render staging environment
...
- [ ] 35. Frontend integration and testing
  - [x] 35.1 Configure React frontend to use Django backend
    - Update API base URL configuration
    - Verify authentication token format compatibility
    - Test CORS configuration
    - _Requirements: 34.2, 34.3, 34.4_

  - [x] 35.2 Run frontend integration tests
  ...
  - [x] 35.3 Test mobile app compatibility
  ...
  - [x] 35.4 Test desktop app compatibility
    - Test Electron app with Django backend
    - Verify all features work correctly
    - _Requirements: 32.1, 32.2_

  - [x] 35.5 Document any frontend changes required

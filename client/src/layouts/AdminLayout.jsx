...
import { LayoutDashboard, Users, Calendar, LogOut, UserCheck, User, Menu, X, ClipboardList, Calculator, UserCog, Bell, Check, Settings, QrCode } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/staff-scanner', label: 'Staff Scanner', icon: QrCode },

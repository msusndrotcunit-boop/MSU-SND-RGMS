        ...
        <SafeAreaProvider>
            ...
            {isSidebarOpen && (
                ...
                <FixedElement 
                    ...
                    className={clsx(
                        "w-64 bg-[var(--primary-color)] text-white flex flex-col transform transition-transform duration-300 ease-in-out z-50 fixed inset-y-0 left-0 md:relative md:translate-x-0 md:flex-shrink-0 md:pointer-events-auto",

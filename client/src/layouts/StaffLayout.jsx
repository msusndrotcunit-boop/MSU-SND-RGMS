            ...
            <MobilePerformanceOptimizer>
                ...
                <Toaster position="top-right" reverseOrder={false} />
                 ...
                 <FixedElement 
                    ...
                    className={clsx(
                        "w-[85vw] max-w-sm md:w-64 bg-primary-surface text-white flex flex-col transform transition-transform duration-300 ease-in-out fixed inset-y-0 left-0 z-50 md:relative md:translate-x-0 md:flex-shrink-0 md:pointer-events-auto",
                    ...
                    {staffProfile && (
                        <div className="flex flex-col items-center mt-4">
                            <Link to="/staff/profile" className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/50 mb-2 bg-gray-200">
                                <img 
                                    src={getProfilePicUrl(staffProfile?.profile_pic, user?.staffId, 'staff')} 
                                    alt="Profile" 

    ...
    return (
        <div className="space-y-6">
            <div className="bg-white dark:bg-gray-800 p-4 md:p-6 rounded shadow">
                ...
                {success && (
                    <div className="bg-green-50 text-green-600 p-3 rounded mb-4 text-sm flex items-center">
                    ...
                    columns={[
                        {
                            ...
                            label: 'Date Absent',
                            render: (_, item) =>
                                new Date(item.date_absent).toLocaleDateString()
                        },
                        {
                            key: 'reason',
                            label: 'Reason',
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
                    <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
                        <h4 className="text-lg font-bold text-gray-800 mb-2">
                            Allow Camera or Files Access
                        </h4>
                        <p className="text-sm text-gray-600 mb-4">
                            To submit your excuse letter, choose whether to use your camera
                            to take a photo or select from your gallery/files.
                        </p>

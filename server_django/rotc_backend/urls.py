...
urlpatterns = [
    ...
    path("api/messages/broadcast", api_views.messages_broadcast_create_view),
    ...
    path("api/cadet/notifications", api_views.cadet_notifications_list_view),
    path("api/notifications/<int:notification_id>/read", api_views.notification_mark_read_view),

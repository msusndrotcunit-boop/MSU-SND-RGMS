...
urlpatterns = [
    ...
    path("api/admin/profile", api_views.admin_profile_view),
    path("api/admin/cadets", api_views.admin_cadets_list_view),
    ...
    path("api/staff", api_views.staff_list_view),
    path("api/staff", api_views.staff_create_view),
    ...
    path("api/staff/<int:staff_id>", api_views.staff_update_view),
    path("api/staff/<int:staff_id>", api_views.staff_delete_view),

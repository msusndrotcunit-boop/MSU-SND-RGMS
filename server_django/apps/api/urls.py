...
urlpatterns = [
    ...
    path('auth/settings', views.auth_settings),
    ...
    path('notifications/<int:nid>', views.notifications_detail),
    path('messages', views.messages_root),
    path('messages/<int:mid>', views.messages_detail),
    path('messages/my', views.messages_my),
    path('admin/cadets', views.admin_cadets),
    path('admin/cadets/<int:cid>', views.admin_update_cadet),
    ...
    path('staff/notifications/delete-all', views.staff_notifications_clear),
